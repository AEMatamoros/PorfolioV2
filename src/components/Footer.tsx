  ...
  return (
    <footer className="main__footer bg-dark dark:bg-light text-light dark:text-dark p-16 flex justify-center items-center flex-col">
      <ul className="sm:w-full md:w-full lg:6/12 xl:6/12 2xl:6/12 flex justify-center gap-4 mb-8">
        <li className="w-16 h-16 bg-main flex justify-center items-center hover:bg-indigo-500 dark:text-light cursor-pointer">
        ...
        <li className="w-16 h-16 bg-main flex justify-center gap-x-8 items-center hover:bg-indigo-500 dark:text-light cursor-pointer">
