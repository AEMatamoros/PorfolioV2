...
export default function About({ title, msg }: { title: string; msg: string }) {
  return (
    <section
      className="flex main__about  justify-center items-center text-dark dark:text-white w-full sm:w-full md:w-full lg:w-6/12 xl:w-6/12 2xl:w-612 sm:p-4 md:p-4 lg:p-8 xl:p-8 text-center section-hidden"
      id="about"
    >
