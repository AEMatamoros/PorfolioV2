...
const proyects = [{
    ...
    descriptionEN: 'It is a free technological platform, created to make it easier for people to exercise the right of access to information. Developed in React, Django, ElasticSearch.',
    img: PortalImg,
    icon: 'fa-light fa-e',
...
},
{
    ...
    descriptionEN: 'Entertainment platform. Developed in Angular, NodeJS, Express, SQL.',
    img: FUTVIMG,
    icon: 'fa-light fa-e',
    url: 'https://portalunico.iaip.gob.hn/#/homeLanding',
},
{
    ...
    descriptionEN: 'Pantry management application. Developed in React, TypeScript.',
    img: ExpenceFrontIMG,
    icon: 'fa-light fa-e',
...
},
{
    ...
    descriptionEN: 'Pantry management application. Developed in NESTJS, MONGO, TypeScript.',
    img: ExpenceBackIMG,
    icon: 'fa-light fa-e',
    url: 'https://github.com/AEMatamoros/our-expence',
},
...
},
{
    ...
    descriptionEN: 'Virtual agenda.Developed with NodeJS, Express and the Handlebars template engine.',
    img: AgendaIMG,
...
},
{
    ...
    descriptionEN: 'Ecommerce, created for the purpose of selling various products. (The API is currently below)',
    img: PhoenixStoreIMG,
...
},
{
    ...
    descriptionEN: 'API to encode a string as a base 64 image with a QR code, as well as encrypt and decrypt the data within it. Developed on NODEJS, Express.',
    img: QrIMG,
    icon: 'fa-light fa-e',
...
},
{
    ...
    descriptionEN: 'Free advertising and product sales page with user profile management. Developed with Python, Django.',
    img: NoImg,
    icon: 'fa-light fa-e',
...
},
{
    ...
    descriptionEN: 'Application to learn to program visually, and showing the generated output code as Python code. Developed in Go, Vue, DGraph.',
    img: LecoIMG,
    icon: 'fa-light fa-e',
    url: 'https://github.com/AEMatamoros/PA-YA',
},
{
    ...
    descriptionEN: 'Application that consumes an external API that provides the weather regarding the current location or a city. Developed in REACT.',
    img: WeatherImg,
    icon: 'fa-light fa-e',
    url: 'https://github.com/AEMatamoros/PA-YA',
},
